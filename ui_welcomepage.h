...
public:
    ...
    void setupUi(QDialog *WelcomePage)
    {
        ...
        label_3->setGeometry(QRect(40, 80, 581, 31));
        QFont font;
        ...
        label_2->setGeometry(QRect(40, 30, 581, 41));
        QFont font1;
        ...
        pushButton->setGeometry(QRect(150, 150, 114, 32));
        pushButton->setAutoDefault(false);
        label_5 = new QLabel(signInBox);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(20, 50, 111, 16));
        label_5->setFont(font);
        username = new QLineEdit(signInBox);
        username->setObjectName(QStringLiteral("username"));
        username->setGeometry(QRect(150, 50, 201, 21));
        password = new QLineEdit(signInBox);
        password->setObjectName(QStringLiteral("password"));
        password->setGeometry(QRect(150, 100, 201, 21));
        ...
        submitForgetPassword->setGeometry(QRect(153, 100, 111, 32));
        submitForgetPassword->setAutoDefault(false);
        label_9 = new QLabel(forgetBox);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(20, 50, 111, 16));
        label_9->setFont(font);
        email = new QLineEdit(forgetBox);
        email->setObjectName(QStringLiteral("email"));
        email->setGeometry(QRect(150, 50, 201, 21));
        ...
        submitInCreateAcc->setGeometry(QRect(149, 190, 111, 32));
        submitInCreateAcc->setAutoDefault(false);
        label_10 = new QLabel(createAnAccountBox);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(20, 50, 111, 16));
        ...
        usernameInCreateAcc->setGeometry(QRect(150, 50, 201, 21));
        passwordInCreateAcc = new QLineEdit(createAnAccountBox);
        passwordInCreateAcc->setObjectName(QStringLiteral("passwordInCreateAcc"));
        passwordInCreateAcc->setGeometry(QRect(150, 100, 201, 21));
        passwordInCreateAcc->setEchoMode(QLineEdit::Password);
        emailInCreateAcc = new QLineEdit(createAnAccountBox);
        emailInCreateAcc->setObjectName(QStringLiteral("emailInCreateAcc"));
        emailInCreateAcc->setGeometry(QRect(150, 150, 201, 21));
        emailInCreateAcc->setEchoMode(QLineEdit::Normal);
        label_11 = new QLabel(createAnAccountBox);
        label_11->setObjectName(QStringLiteral("label_11"));
        label_11->setGeometry(QRect(20, 150, 111, 16));
